    ...
    if (status === "authenticated") {
      return (
        <>
          <aside
            id="logo-sidebar"
            className="fixed top-0 left-0 z-40 w-64 h-screen pt-5 transition-transform -translate-x-full border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
            aria-label="Sidebar"
          >
             <Link href="/">
            <div className="flex items-center justify-start mx-auto px-2 mb-1">
              ...
              <img
                ...
                alt="Whizzo Logo"
              />
              <span className="dark:text-white self-center text-xl font-semibold whitespace-nowrap text-black">
                Whizzo
              </span>
              
            </div>
            
            <p className="pb-12 px-14 text-xs text-gray-300">
              Sprint Reviews done quick!
            </p>
            </Link>
            <div className="px-3 pb-4 overflow-y-auto dark:bg-gray-800 grid h-1/2 place-items-center">
              <ul className="space-y-2">
              <li className="pb-1">
                  <Link
                    href="/meetings/freg"
                    className="flex items-center p-2 text-base font-normal text-gray-200 rounded-lg dark:text-white hover:bg-gray-300 dark:hover:bg-gray-700 hover:text-black"
                  >
                    <span className="flex-1 ml-3 whitespace-nowrap hover:cursor-help">
                      Trial Edition
                    </span>
                ...
                <li className="pb-1">
                  ...
                  >
                    <svg
                      aria-hidden="true"
                      className="flex-shrink-0 w-6 h-6 text-slate-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                ...
                <li className="pb-1">
                  <button
                    type="button"
                    className="flex w-full items-center p-2 text-base font-normal text-gray-200 rounded-lg dark:text-white hover:bg-gray-300 dark:hover:bg-gray-700 hover:text-black"
                    aria-controls="dropdown-example"
                    data-collapse-toggle="dropdown-example"
                  >
                    <svg
                      aria-hidden="true"
                      className="flex-shrink-0 w-6 h-6 text-slate-400 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                      xmlns="http://www.w3.org/2000/svg"
                    >
